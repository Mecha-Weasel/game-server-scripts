...
#
#	----------------------------------------------------------------------------
#	Run a Counter-Strike 1.6 (CS1) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Counter-Strike 1.6 (CS1) dedicated game-server instance.
...
#		Example:
#		
#			./run-game-cs1.sh gameserverid 27015;
#	
