...
#
#	----------------------------------------------------------------------------
#	Run a Counter-Strike:Source (CSS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Counter-Strike:Source (CSS) dedicated game-server instance.
...
#		Example:
#		
#			./run-game-css.sh gameserverid 27015;
#	
...
MOD_SUB_FOLDER="cstrike"
BASE_FOLDER="$INSTALL_FOLDER/$MOD_SUB_FOLDER";	
SCRIPT_LOG_FILE="$HOME/logs/$GAME_SERVER.log";
GAME_START_COMMAND="nice -n 10 ./srcds_run -game $MOD_SUB_FOLDER -secure -port $SERVER_PORT";
#
