...
#
#	----------------------------------------------------------------------------
#	Run a Day of Defeat (DoD) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Day of Defeat (DoD) server dedicated game-server instance.
...
#		Example:
#		
#			./run-game-dod.sh gameserverid 27015;
#	
