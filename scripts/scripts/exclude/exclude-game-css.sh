...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Counter-Strike:Source (CSS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Build a backup exclusion list for Counter-Strike:Source (CSS) game server content.
#
...
#		Example:
#		
#			./exclude-game-css.sh gameserverid;
#	
...
GAME_APPID="232330";														# what "AppID" (i.e. which game) to install.
MOD_SUB_FOLDER="cstrike";													# which sub-folder of the installation folder the game shows-up inside of.
STEAMCMD_COMMAND_OPTIONS="+app_set_config $GAME_APPID +app_update $GAME_APPID";	# Any special installation options to use in/around the "AppID" information.
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-css";								# temp folder where game-server will be installed.
