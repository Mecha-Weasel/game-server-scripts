...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Fistful of Frags (FoF) game-server
#	============================================================================
...
#	Purpose:
#	
#		Build a backup exclusion list for Fistful of Frags (FoF) game server content.
#
...
#		Example:
#		
#			./exclude-game-fof.sh gameserverid;
#	
...
GAME_APPID="295230";														# what "AppID" (i.e. which game) to install.
MOD_SUB_FOLDER="fof";														# which sub-folder of the installation folder the game shows-up inside of.
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-fof";								# temp folder where game-server will be installed.
