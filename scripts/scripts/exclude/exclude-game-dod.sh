...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Day of Defeat (DoD) game-server
#	============================================================================
...
#	Purpose:
#	
#		Build a backup exclusion list for Day of Defeat (DoD) game server content.
#
...
#		Example:
#		
#			./exclude-game-dod.sh gameserverid;
#	
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-dod";								# temp folder where game-server will be installed.
