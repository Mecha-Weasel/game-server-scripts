...
#
#	----------------------------------------------------------------------------
#	Stop a background Counter-Strike 1.6 (CS1) game-server
#	============================================================================
...
#	Purpose:
#	
#		Stop (an already started in the background) Counter-Strike 1.6 (CS1) game-server
...
#
#	Display various parameters being used ...
#
