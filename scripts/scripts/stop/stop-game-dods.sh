...
#
#	----------------------------------------------------------------------------
#	Stop a background Day of Defeat:Source (DoDS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Stop (an already started in the background) Day of Defeat:Source (DoDS) game-server
...
#		Example:
#		
#			./stop-game-dods.sh gameserverid;
#	
...
SHUTDOWN_ALERT_DISPLAY_COMMAND="sm_say ALERT: Server shutting-down or restarting NOW!$(printf \\r)";
SHUTDOWN_ALERT_PLAY_COMMAND="sm_play @humans sound/weaselslair/alerts/alert-shutdown-initiated.mp3$(printf \\r)";
#
