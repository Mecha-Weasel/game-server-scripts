...
#
#	----------------------------------------------------------------------------
#	Stop a background Counter-Strike:Source (CSS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Stop (an already started in the background) Counter-Strike:Source (CSS) game-server
