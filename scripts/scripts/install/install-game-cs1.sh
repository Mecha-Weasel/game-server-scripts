...
#
#	----------------------------------------------------------------------------
#	Install a Counter-Strike 1.6 (CS1) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Counter-Strike 1.6 (CS1) dedicated game-server instance.
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Counter-Strike 1.6 (CS1) game-server";		# a description for logging purposes.
