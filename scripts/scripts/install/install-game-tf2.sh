...
#
#	----------------------------------------------------------------------------
#	Install a Team Fortress 2 (TF2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Team Fortress 2 (TF2) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-tf2.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Team Fortress 2 (TF2) game-server";		# a description for logging purposes.
STEAM_LOGIN="anonymous";												# what Steam user-name and password to use (e.g. "anonymous" or "username password").
GAME_APPID="232250";													# what "AppID" (i.e. which game) to install.
MOD_SUB_FOLDER="tf";													# which sub-folder of the installation folder the game shows-up inside of.
