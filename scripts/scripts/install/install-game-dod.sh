...
#
#	----------------------------------------------------------------------------
#	Install a Day of Defeat (DoD) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Day of Defeat (DoD) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-dod.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Day of Defeat (DoD) game-server";		# a description for logging purposes.
