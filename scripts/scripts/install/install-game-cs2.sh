...
#
#	----------------------------------------------------------------------------
#	Install a Counter-Strike 2 (CS2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Counter-Strike 2 (CS2) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-cs1.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Counter-Strike 2 (CS2) game-server";		# a description for logging purposes.
...
STEAMCMD_COMMAND_OPTIONS="+app_update $GAME_APPID validate";							# Any special installation options to use in/around the "AppID" information.
