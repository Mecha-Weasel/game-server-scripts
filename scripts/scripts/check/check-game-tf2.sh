...
#
#	----------------------------------------------------------------------------
#	Conditionally update a Team Fortress 2 (TF2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Update a Team Fortress 2 (TF2) dedicated game-server instance, only if an update is available.
...
#		Example:
#		
#			./check-game-tf2.sh gameserverid;
#	
