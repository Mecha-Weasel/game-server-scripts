...
#
#	----------------------------------------------------------------------------
#	Conditionally update a Counter-Strike 2 (CS2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Update a Counter-Strike 2 (CS2) dedicated game-server instance, only if an update is available.
...
#		Example:
#		
#			./check-game-cs2.sh gameserverid;
#	
