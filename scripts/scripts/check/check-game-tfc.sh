...
#
#	----------------------------------------------------------------------------
#	Conditionally update a Team Fortress Classic (TFC) game-server
#	============================================================================
...
#	Purpose:
#	
#		Update a Team Fortress Classic (TFC) dedicated game-server instance, only if an update is available.
...
#		Example:
#		
#			./check-game-tfc.sh gameserverid;
#	
