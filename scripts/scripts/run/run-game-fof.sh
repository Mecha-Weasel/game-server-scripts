...
#
#	----------------------------------------------------------------------------
#	Run a Fistful of Frags (FoF) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Fistful of Frags (FoF) dedicated game-server instance.
...
#		Example:
#		
#			./run-game-fof.sh gameserverid 27015;
#	
