...
#
#	----------------------------------------------------------------------------
#	Run a Counter-Strike 2 (CS2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Counter-Strike 2 (CS2) dedicated game-server instance.
...
#	port
#	
#		The UDP port that the game-server will listen-on for normal
#		client/server communication.
#		
#		Example:
#		
#			./run-game-cs2.sh gameserverid 27015;
#
#	NOTE: Based on notes from here:
#		https://developer.valvesoftware.com/wiki/Counter-Strike_2/Dedicated_Servers
#	
#	NOTE: Requires the following symbolic link ... to link steamclient.so into a new folder.
...
MOD_SUB_FOLDER="game/csgo"
BASE_FOLDER="$INSTALL_FOLDER/$MOD_SUB_FOLDER";
SCRIPT_LOG_FILE="$HOME/logs/$GAME_SERVER.log";
GAME_START_COMMAND="nice -n 9 ./game/bin/linuxsteamrt64/cs2 -dedicated -secure -port $SERVER_PORT -usercon -nodefaultmap -maxplayers 64 +exec autoexec.cfg";
#
