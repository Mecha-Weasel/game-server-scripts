...
#
#	----------------------------------------------------------------------------
#	Run a Team Fortress Classic (TFC) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Team Fortress Classic (TFC) dedicated game-server instance.
...
#		Example:
#		
#			./run-game-tfc.sh gameserverid 27015;
#	
