...
#
#	----------------------------------------------------------------------------
#	Run a Day of Defeat:Source (DoDS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Day of Defeat:Source (DoDS)  dedicated game-server instance.
...
#		Example:
#		
#			./run-game-dods.sh gameserverid 27015;
#	
