...
#
#	----------------------------------------------------------------------------
#	Run a Deathmatch Classic (DMC) game-server
#	============================================================================
...
#	Purpose:
#	
#		Run (an already installed) a Deathmatch Classic (DMC) server dedicated game-server instance.
...
#		Example:
#		
#			./run-game-dmc.sh gameserverid 27015;
#	
