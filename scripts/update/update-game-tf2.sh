...
#
#	----------------------------------------------------------------------------
#	Update a Team Fortress 2 (TF2) game-server, restarting if needed
#	============================================================================
...
#	Purpose:
#	
#		Update a Team Fortress 2 (TF2) dedicated game-server instance.
...
#		Example:
#		
#			./update-game-tf2.sh gameserverid;
#	
...
SHUTDOWN_ALERT_PLAY_COMMAND="amx_sound_play sound/weaselslair/alerts/alert-update-tf2.mp3$(printf \\r)";
#
