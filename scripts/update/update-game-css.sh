...
#
#	----------------------------------------------------------------------------
#	Update a Counter-Strike:Source (CSS) game-server, restarting if needed
#	============================================================================
...
#	Purpose:
#	
#		Update a Counter-Strike:Source (CSS) dedicated game-server instance.
...
#		Example:
#		
#			./update-game-css.sh gameserverid;
#	
...
SHUTDOWN_ALERT_PLAY_COMMAND="amx_sound_play sound/weaselslair/alerts/alert-update-css.mp3$(printf \\r)";
#
