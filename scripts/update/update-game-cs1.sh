...
#
#	----------------------------------------------------------------------------
#	Update a Counter-Strike 1.6 (CS1) game-server, restarting if needed
#	============================================================================
...
#	Purpose:
#	
#		Update a Counter-Strike 1.6 (CS1) dedicated game-server instance.
...
#		Example:
#		
#			./update-game-cs1.sh gameserverid;
#	
...
SHUTDOWN_ALERT_PLAY_COMMAND="amx_sound_play sound/weaselslair/alerts/alert-update-cs1.mp3$(printf \\r)";
#
