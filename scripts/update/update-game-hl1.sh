...
#
#	----------------------------------------------------------------------------
#	Update a Half-Life (HL1) game-server, restarting if needed
#	============================================================================
...
#	Purpose:
#	
#		Update a Half-Life (HL1) dedicated game-server instance.
...
#		Example:
#		
#			./update-game-hl1.sh gameserverid;
#	
...
#
MOD_SUB_FOLDER="valve";													# which sub-folder of the installation folder the game shows-up inside of.
...
SHUTDOWN_ALERT_PLAY_COMMAND="amx_sound_play sound/weaselslair/alerts/alert-update-hl1.mp3$(printf \\r)";
#
