...
#
#	----------------------------------------------------------------------------
#	Update a Fistful of Frags (FoF) game-server, restarting if needed
#	============================================================================
...
#	Purpose:
#	
#		Update a Fistful of Frags (FoF) dedicated game-server instance.
...
#		Example:
#		
#			./update-game-fof.sh gameserverid;
#	
...
SHUTDOWN_ALERT_PLAY_COMMAND="amx_sound_play sound/weaselslair/alerts/alert-update-fof.mp3$(printf \\r)";
#
