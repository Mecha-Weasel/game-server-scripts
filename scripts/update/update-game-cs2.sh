...
#
#	----------------------------------------------------------------------------
#	Update a Counter-Strike 2 (CS2) game-server, restarting if needed
#	============================================================================
...
#	Purpose:
#	
#		Update a Counter-Strike 2 (CS2) dedicated game-server instance.
...
#		Example:
#		
#			./update-game-cs2.sh gameserverid;
#	
...
SHUTDOWN_ALERT_PLAY_COMMAND="amx_sound_play sound/weaselslair/alerts/alert-update-cs2.mp3$(printf \\r)";
#
