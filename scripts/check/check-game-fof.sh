...
#
#	----------------------------------------------------------------------------
#	Conditionally update a Fistful of Frags (FoF) game-server
#	============================================================================
...
#	Purpose:
#	
#		Update a Fistful of Frags (FoF) dedicated game-server instance, only if an update is available.
...
#		Example:
#		
#			./check-game-fof.sh gameserverid;
#	
