...
#
#	----------------------------------------------------------------------------
#	Conditionally update a Counter-Strike:Source (CSS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Update a Counter-Strike:Source (CSS) dedicated game-server instance, only if an update is available.
...
#		Example:
#		
#			./check-game-css.sh gameserverid;
#	
