...
#
#	----------------------------------------------------------------------------
#	Stop a background Counter-Strike 2 (CS2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Stop (an already started in the background) Counter-Strike 2 (CS2) game-server
