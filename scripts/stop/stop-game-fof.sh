...
#
#	----------------------------------------------------------------------------
#	Stop a background Fistful of Frags (FoF) game-server
#	============================================================================
...
#	Purpose:
#	
#		Stop (an already started in the background) Fistful of Frags (FoF) game-server
