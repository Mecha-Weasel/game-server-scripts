...
#
#	----------------------------------------------------------------------------
#	Install a Half-Life (HL1) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Half-Life (Hl1) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-hl1.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Half-Life (HL1) game-server";		# a description for logging purposes.
