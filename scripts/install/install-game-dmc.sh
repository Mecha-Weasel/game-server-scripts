...
#
#	----------------------------------------------------------------------------
#	Install a Deathmatch Classic (DMC) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Deathmatch Classic (DMC) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-dmc.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Deathmatch Classic (DMC) game-server";		# a description for logging purposes.
