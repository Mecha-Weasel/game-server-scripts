...
#
#	----------------------------------------------------------------------------
#	Install a Counter-Strike:Source (CSS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Counter-Strike:Source (CSS) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-css.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Counter-Strike:Source (CSS) game-server";		# a description for logging purposes.
...
STEAMCMD_COMMAND_OPTIONS="+app_update $GAME_APPID";						# Any special installation options to use in/around the "AppID" information.
