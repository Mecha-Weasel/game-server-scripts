...
#
#	----------------------------------------------------------------------------
#	Install a Team Fortress Classic (TFC) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Team Fortress Classic (TFC) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-tfc.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Team Fortress Classic (TFC) game-server";		# a description for logging purposes.
