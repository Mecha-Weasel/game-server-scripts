...
#
#	----------------------------------------------------------------------------
#	Install a Fistful of Frags (FoF) game-server
#	============================================================================
...
#	Purpose:
#	
#		Install a Fistful of Frags (FoF) dedicated game-server instance.
...
#		Example:
#		
#			./install-game-fof.sh gameserverid;
#	
...
#
SERVER_DESCRIPTION="[$GAME_SERVER] Fistful of Frags (FoF) game-server";		# a description for logging purposes.
