...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Day of Defeat:Source (DoDS) game-server
#	============================================================================
...
#	Purpose:
#	
#		Build a backup exclusion list for Day of Defeat:Source (DoDS) game server content.
#
...
#		Example:
#		
#			./exclude-game-dods.sh gameserverid;
#	
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-dods";								# temp folder where game-server will be installed.
