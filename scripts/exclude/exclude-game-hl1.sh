...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Half-Life (HL1) game-server
#	============================================================================
...
#		Example:
#		
#			./exclude-game-hl1.sh gameserverid;
#	
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-hl1";								# temp folder where game-server will be installed.
