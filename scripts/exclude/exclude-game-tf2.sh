...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Team Fortress 2 (TF2) game-server
#	============================================================================
...
#	Purpose:
#	
#		Build a backup exclusion list for Team Fortress 2 (TF2) game server content.
#
...
#		Example:
#		
#			./exclude-game-tf2.sh gameserverid;
#	
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-tf2";								# temp folder where game-server will be installed.
