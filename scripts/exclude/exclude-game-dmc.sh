...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Deathmatch Classic (DMC) game-server
#	============================================================================
...
#	Purpose:
#	
#		Builf a backup exclusion list for Deathmatch Classic (DMC) game server content.
#
...
#		Example:
#		
#			./exclude-game-dmc.sh gameserverid;
#	
...
MOD_SUB_FOLDER="dmc";														# which sub-folder of the installation folder the game shows-up inside of.
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-dmc";								# temp folder where game-server will be installed.
