...
#
#	----------------------------------------------------------------------------
#	Build a backup exclusion list for a Counter-Strike 1.6 (CS1) game-server
#	============================================================================
...
#	Purpose:
#	
#		Build a backup exclusion list for Counter-Strike 1.6 (CS1) game server content.
#
...
#		Example:
#		
#			./exclude-game-cs1.sh gameserverid;
#	
...
INSTALL_FOLDER="$TEMPWORK_FOLDER/stock-cs1";								# temp folder where game-server will be installed.
